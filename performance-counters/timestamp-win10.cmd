...
@rem create a timestamp in Windows 10
...
@rem windows 2008
@rem set "futureTime=%h%:%m:~1%:%s:~1%"  &  set "futureDate=%D:~4,2%/%D:~6,2%/%D:~0,4%"

@rem windows 10
set "futureTime=%h%:%m:~1%:%s:~1%"  &  set "futureDate=%D:~0,4%-%D:~4,2%-%D:~6,2%"
